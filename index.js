...
function choose(play) {
	...
	if (play == 0 && computer == 1) {
		//lose
		result.innerHTML = "YOU LOSE";
		s--;
	}

	if (play == 0 && computer == 2) {
		//win
		result.innerHTML = "YOU WIN";
		s++;
	}

	if (play == 1 && computer == 0) {
		//win
		result.innerHTML = "YOU WIN";
		s++;
	}

	if (play == 1 && computer == 1) {
		//tie
		result.innerHTML = "TIE";
	}

	if (play == 1 && computer == 2) {
		//lose
		result.innerHTML = "YOU LOSE";
		s--;
	}

	if (play == 2 && computer == 0) {
		//lose
		result.innerHTML = "YOU LOSE";
		s--;
	}

	if (play == 2 && computer == 1) {
		//win
		result.innerHTML = "YOU WIN";
		s++;
	}

	if (play == 2 && computer == 2) {
		//tie
		result.innerHTML = "TIE";
	}
